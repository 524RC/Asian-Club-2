...
function person1() {
  ...
  function person3() {
    ...
    document.getElementById('message')
      .innerHTML = "Ann Alex";
    document.getElementById('info')
      .innerHTML = "Hello! I am Ann, the Junior Vice President this year! I have been in Asian Club since freshman year and fell in love with everything about it.From the friends I have made, experiences I shared, and the things I have learned, I hope to share that with you. Asian Club has always been about understanding the vibrant culture of Asia, whether that be learning or simply experiencing some of the traditions.  I am excited to host all of our recurring and new events and hope to see you there! I am thrilled to be apart of this years board, and excited to make this year as memorable as possible!";
  }
  ...
  function person4() {
    ...
    document.getElementById('info')
      .innerHTML = "Hello everyone! In my role as the Secretary of the Asian Club, I'm thrilled to kick off this academic year with excitement and anticipation. As a senior, I'm excited about the possibilities that lie ahead for our club. Over the years, the Asian Club has been a source of unity and cultural richness, and I'm committed to making this final year a memorable one for all of us. Let's have a great year with plenty more to come!";
  }
  ...
  function person5() {
    ...
    document.getElementById('info')
      .innerHTML = "Hi everyone! My name is Annika Bhatia and I am the treasurer of Asian club this year. I have been a part of Asian Club since my sophomore year, and I cannot wait to share with you all what we have planned this year! Asian Club has always been an amazing community to be a part of because of how inclusive we are of all Asian cultures. Now as a senior, I am excited to make this years Asian Club the best one yet and create endless memories with you all!";
  }
  ...
  function person7() {
    ...
    document.getElementById('info')
      .innerHTML = "Hi everyone! In my role as the communications director for the Asian Club this year, I am so thrilled about the upcoming events that will be vibrant celebrations of our diverse asian cultures. Our club is a home for all who wish to embrace the beauty of Asian traditions, fostering an environment of learning and appreciation! I am genuinely excited to promote these goals within our community and create lasting memories that will define this year in the club.";
  }
  ...
  function person8() {
    ...
    document.getElementById('info')
      .innerHTML = "Hey!! As an Art Director of the Asian Club, I’m delighted to work with the Asian Art Committee to make all the beautiful decorations and art work for the club. It brings so much joy and pride to see the final products displayed at the wonderful and exciting events hosted by Asian Club. I work with the other board members, and we are all dedicated to making each event special and memorable."
  }
